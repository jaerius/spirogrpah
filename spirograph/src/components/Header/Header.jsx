      ...
      <div className="flex gap-5 items-start text-sm font-bold text-white max-md:flex-wrap">
        <div className="flex flex-col">
          <div className="img-container">
            ...
            />
            <div
              className="mt-1 text-custom text-left mr-14"
        ...
        <div className="flex flex-col whitespace-nowrap max-md:max-w-full">
          <div className="img-container">
            <img
              ...
              style={{ height: "0px" }}
            />
            <div className="mt-1 text-custom max-md:max-w-full text-left">
              SHOP
            </div>
          </div>
        </div>
          ...
          <div className="flex max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-[35%] max-md:ml-0 max-md:w-full">
              <div className="firstExplanation">
                <div className="text-custom ml-7 text-left font-medium leading-custom text-neutral-400 max-md:mt-6">
                  ...
                  인터페이스를 커스텀을 도와주는 디자인 스튜디오 입니다.{" "}
                  {"     "}도형 ‘원' 을 기반으로 그래픽이 생성 되며 추가로
                  개인의 맞춤 성향을 위한 ai가 커스텀을 도와줍니다. 우리의 ‘The
                  Symbol ’을 통해 자신만의 ‘ai 어시스턴트’를 제작해보세요 !
                </div>
              </div>
            </div>
            <div className="flex flex-col ml-5 w-[50%] max-md:ml-0 max-md:w-full">
              <div className="text-custom text-left ml-1 font-medium leading-custom text-neutral-400 max-md:mt-6 max-md:max-w-full">
                ...
                상징물로서, 하이포 사이클로이드의 기하학적 특성에서 착안했다.
                하이포 사이클로이드는 큰 원의 내부를 맴도는 작은 원의 경계에{" "}
