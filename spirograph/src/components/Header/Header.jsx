...
export const Header = () => {
  ...
  return (
    <div className="flex flex-col px-5 w-full max-w-full">
        ...
        <div className="flex flex-col max-w-full">
          <div className="img-container">
            <img
              ...
              className="w-full border border-solid border-stone-500 stroke-[1px] stroke-stone-500 max-w-full"
              style={{ height: "0px" }}
            />
            <div className="mt-1 text-custom max-w-full text-left">SHOP</div>
          </div>
        </div>
        <div className="flex flex-col self-end text-lg fixed top-[1.5vh] right-[1.5vw] max-w-full">
          <div className="img-container">
            <img
              loading="lazy"
          ...
          <div className="flex flex-col text-left text-custom text-neutral-400 font-medium leading-4 mb-8">
            <div className="flex">
              <div className="flex flex-col mr-4">
                <div className="whitespace-nowrap">_hhesta ©</div>
                <div className="whitespace-nowrap">1999-2024</div>
              </div>
              <div className="text-3xl text-custom font-thin leading-9 text-gray-200 mr-4">
                /
              </div>
              <div className="flex flex-col">
                <div className="whitespace-nowrap">_hhesta ©</div>
      ...
      <div className="flex self-start mt-12 flex-wrap mt-10">
        <img
          src="/assets/images/newSymbol.svg"
          alt="Symbol"
          className="symbol-img"
        />
        <div className="flex-auto self-start ml-4 mt-0 max-w-full">
          <div className="flex flex-col max-w-full">
            <div className="flex flex-col w-[35%] max-w-full">
              <div className="firstExplanation">
                <div className="text-custom ml-7 text-left font-medium leading-custom text-neutral-400 mt-6">
            ...
            <div className="flex flex-col ml-5 w-[50%] max-w-full">
              <div className="text-custom text-left ml-1 font-medium leading-custom text-neutral-400 mt-6 max-w-full">
